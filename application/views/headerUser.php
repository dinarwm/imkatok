...
<!-- CSS -->
<link rel='stylesheet' id='mailchimpSF_main_css-css'  href='<?php echo base_url() ?>css/fix/Sterling.css' type='text/css' media='all' />
    ...
    <aside class="top-aside clearfix">
        <div class="center-wrap">
            ...
            <div class="one_half">
                <div class="sidebar-widget social_widget">
					<ul>
						<li><a href="<?php echo base_url() ?>auth/doLogout" onclick="window.open(this.href);return false;">Keluar</a></li>
					</ul>
        		</div>            
...
<li id="menu-item-1075" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1075"><a href="<?php echo base_url();?>home">Beranda</a></li>
    <li id="menu-item-1072" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-1072"><a href="<?php echo base_url();?>kalender_kehamilan/infografik">Infografik</a></li>
